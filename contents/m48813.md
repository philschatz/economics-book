...
Similarly, many central banks ran highly expansionary monetary policies, with both near-zero interest rates and unconventional loans and investments. For example, in 2012, Shinzo Abe (see [\[link\]](#CNX_Econ_C32_007)), then newly-elected Prime Minister of Japan, unveiled a plan to get his country out of its two-decade-long slump in economic growth. It included both fiscal stimulus and an increase in the money supply. The plan was quite successful in the short run. However, according to the *Economist*, with public debt “expected to approach 240% of GDP,” printing money and public-works spending were only short-term solutions.

![This is a photo of Japan&#x2019;s Prime Minister, Shinzo Abe.](../resources/CNX_Econ_C32_007_1R.jpg "Japan&#x2019;s Prime Minister used fiscal and monetary policies to stimulate his country&#x2019;s economy, which has worked in only the short run. (Credit: modification of work by Chatham House/Flickr Creative Commons)"){: #CNX_Econ_C32_007 data-media-type="image/jpg" data-title="Japan&#x2019;s Prime Minister, Shinzo Abe"}
...
<span data-type="media" id="Ch32Mod02QR01" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/worldfactbook01.png){: data-media-type="image/png"} </span>
</div>
...
<span data-type="media" id="Ch32Mod02QR02" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/foodafrica.png){: data-media-type="image/png"} </span>
</div>
...
<li>Create, invest in, and apply new technologies</li>
<li>Adopt fiscal policies focused on investment, including investment in human capital, in technology, and in physical plant and equipment</li>
<li>Create stable and market-oriented economic climate</li>
<li>Use monetary policy to keep inflation low and stable</li>
<li>Minimize the risk of exchange rate fluctuations, while also encouraging domestic and international competition</li>
</ul></td>
<td>
<ul>
<li>Invest in technology, human capital, and physical capital</li>
<li>Provide incentives of a market-oriented economic context</li>
<li>Work to reduce government economic controls on market activities</li>
<li>Deregulate the banking and financial sector</li>
<li>Reduce protectionist policies</li>
</ul>
</td>
<td>
<ul>
<li>Eradicate poverty and extreme hunger</li>
...
<li>Develop global partnerships for development</li>
</ul>
</td>
</tr>
</tbody></table>
...
Using the research skills you have acquired, retrieve the following data from The World Bank database (http://databank.worldbank.org/data/home.aspx) for India, Spain, and South Africa for 2008–2012, if available:
