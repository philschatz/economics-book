...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/Movietickets.png){: data-media-type="image/png"} </span>
</div>
