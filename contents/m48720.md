...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/BLS1.png){: data-media-type="image/png"} </span>
</div>
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/BLS_CPS.png){: data-media-type="image/png"} </span>
</div>
