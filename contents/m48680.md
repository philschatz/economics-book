...
<div data-type="note" id="ch13mod03_link01" class="economics linkup" data-label="" markdown="1">
Visit this [website][1] to read about a connection between free riders and “bad music.”

<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/freerider.png){: data-media-type="image/png"} </span>
</div>
...
<td>
<ul data-bullet-style="none"><li>R pays $4, receives $6, net gain +$2</li>
<li>S pays $4, receives $6, net gain +$2</li>
</ul></td>
<td>
<ul data-bullet-style="none"><li>R pays $4, receives $3, net gain –$1</li>
<li>S pays $0, receives $3, net gain +$3</li>
</ul></td>
</tr>
<tr>
<td>Rachel (R) Do Not Contribute</td>
<td>
<ul data-bullet-style="none"><li>R pays $0, receives $3, net gain +$3</li>
<li>S pays $4, receives $3, net gain –$1</li>
</ul></td>
<td>
<ul data-bullet-style="none"><li>R pays $0, receives $0</li>
<li>S pays $0, receives $0</li>
</ul></td>
</tr>
</tbody></table>
...
<div data-type="note" id="ch13mod03_workout01" class="economics workout" data-label="" markdown="1">
<div data-type="title">
...
<div data-type="note" id="ch13mod03_link02" class="economics linkup" data-label="" markdown="1">
Read this [article][2] to find out what economists say the government should pay for.

<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/governmentpay.png){: data-media-type="image/png"} </span>
</div>
...
<div data-type="note" id="ch13mod03_link03" class="economics linkup" data-label="" markdown="1">
Visit this [website][3] for more on the queen conch industry.

<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/queenconch.png){: data-media-type="image/png"} </span>
</div>
...
<div data-type="note" id="ch13mod03_bringhome01" class="economics bringhome" data-label="" markdown="1">
<div data-type="title">
