...
<span data-type="title">Solution</span>The following figure shows the aggregate expenditure-output diagram with the recessionary gap. ![The graph shows the aggregate expenditure-output diagram with a recessionary gap.](../resources/CNX_Econ_C25_011.jpg){: #CNX_Econ_C25_011a data-media-type="image/jpeg"}
