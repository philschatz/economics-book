...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/NASA.png){: data-media-type="image/png"} </span>
</div>
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/REtaxcredit.png){: data-media-type="image/png"} </span>
</div>
