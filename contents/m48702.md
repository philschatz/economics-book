...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/votergroups.png){: data-media-type="image/png"} </span>
</div>
...
Mancur Olson. *The Logic of Collective Action: Public Goods and the Theory of Groups*, (Boston: Harvard University Press, 1965).
...
U.S. Department of Commerce: United States Census Bureau. “Voting and Registration: Historical Time Series Tables; Table A-9: Reported Voting Rates in Presidential Election Years, by Selected Characteristics: November 1964 to 2012.”
