...
<span data-type="media" id="ch26mod02_link01m" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/Haubrich01.png){: data-media-type="image/png"} </span>
</div>
...
<span data-type="media" id="ch26mod02_link02m" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/modeledbehavior01.png){: data-media-type="image/png"} </span>
</div>
...
<span data-type="media" id="ch26mod02_link03m" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/inflatemploy01.png){: data-media-type="image/png"} </span>
</div>
...
Legislation proposes that the government should use macroeconomic policy to achieve an unemployment rate of zero percent, by increasing aggregate demand for as much and as long as necessary to accomplish this goal. From a neoclassical perspective, how will this policy affect output and the price level in the short run and in the long run? Sketch an aggregate supply-aggregate demand diagram to illustrate your answer. (Hint: revisit [The Rebound to Potential GDP after AD Increases in The Building Blocks of Neoclassical Analysis](/m48758#CNX_Econ_C26_003))
...
Haubrich, Joseph G., George Pennacchi, and Peter Ritchken. Federal Reserve Bank of Cleveland. “Working Paper 11-07: Inflation Expectations, Real Rates, and Risk Premia: Evidence from Inflation Swaps.” Last modified March 2011. http://www.clevelandfed.org/research/workpaper/2011/wp1107.pdf.
