...
<table id="Table_07_01" summary="The bottom 10 states that pay the Lowest benefit per week are George ($330), South Carolina ($326), Missouri ($320), South Dakota ($295), Florida ($275), Tennessee ($275), Alabama ($265), Louisiana ($258), Arizona ($240), Mississippi ($235). The top 10 states that pay the highest benefit per week are Massachusetts ($653), Washington ($604), New Jersey ($600), Minnesota ($585), Pennsylvania ($573), Rhode Island ($566), Hawaii ($560), Connecticut ($555), Ohio ($524), Oregon ($507)."><caption><span data-type="title">Average Weekly Unemployment Benefits by State in 2013</span>(Source: jobsearch.about.com/od/unemployment/a/weekly-unemployment-benefits.htm)</caption><thead>
<tr>
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/NYT_Benefits.png){: data-media-type="image/png"} </span>
</div>
...
[\[link\]](/m48791) and the [\[link\]](/m48811)chapters provide a detailed discussion of how to fight unemployment, when these policies can be discussed in the context of the full array of macroeconomic goals and frameworks for analysis. But even at this preliminary stage, it is useful to preview the main issues concerning policies to fight unemployment.

The remedy for unemployment will depend on the diagnosis. Cyclical unemployment is a short-term problem, caused because the economy is in a recession. Thus, the preferred solution will be to avoid or minimize recessions. As [\[link\]](/m48791) discusses, this policy can be enacted by stimulating the overall buying power in the economy, so that firms perceive that sales and profits are possible, which makes them eager to hire.
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Explain what happens to the gap between real GDP and potential GDP when cyclical unemployment increases? When the natural rate of unemployment increases?
